...
# ==========================================
# 투자판단은 제외 — '투자판단관련주요경영사항' 전체를 시장속보로 브로드캐스트하면
# 비보유 종목까지 도배됨(대부분 자율공시). 대신 그중 실제 시장 재료인 계약(라이선스·
# 기술이전·기술수출)만 포함 → 계약류 비보유 종목은 시장속보, 일반 투자판단은 미발송.
# (보유 종목은 is_my_stock 경로라 이 목록과 무관하게 major로 전달됨)
